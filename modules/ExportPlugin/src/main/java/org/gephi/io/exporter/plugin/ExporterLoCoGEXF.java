 ...
 */
public class ExporterLoCoGEXF implements GraphExporter, CharacterExporter, LongTask {
    ...
    private void writeNodeRole(XMLStreamWriter xmlWriter, Node node) throws Exception {
        xmlWriter.writeStartElement(VIZ, NODE_ROLE, VIZ_NAMESPACE);
        int role = node.role();
        xmlWriter.writeAttribute("value", "" + role);
        xmlWriter.writeEndElement();
    }
    ...
    public String getName() {
        return NbBundle.getMessage(getClass(), "ExporterLoCoGEXF_name");
    }

    public FileType[] getFileTypes() {
        FileType ft = new FileType(".gexf", NbBundle.getMessage(getClass(), "fileType_LoCo_GEXF_Name"));
