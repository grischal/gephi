 ...
 */
public class UIExporterLoCoGEXFPanel extends javax.swing.JPanel {

    /**
     * Creates new form UIExporterGEXFPanel
     */
    public UIExporterLoCoGEXFPanel() {
        initComponents();
    }

    public void setup(ExporterLoCoGEXF exporterGEXF) {
        ...
        roleExportCheckbox.setSelected(exporterGEXF.isExportRole());
    ...
    public void unsetup(ExporterLoCoGEXF exporterGEXF) {
        ...
        exporterGEXF.setExportRole(roleExportCheckbox.isSelected());
    ...
    private void initComponents() {
        ...
        roleExportCheckbox = new javax.swing.JCheckBox();

        labelExport.setText(org.openide.util.NbBundle.getMessage(UIExporterLoCoGEXFPanel.class, "UIExporterGEXFPanel.labelExport.text")); // NOI18N

        positionExportCheckbox.setText(org.openide.util.NbBundle.getMessage(UIExporterLoCoGEXFPanel.class, "UIExporterGEXFPanel.positionExportCheckbox.text")); // NOI18N

        colorsExportCheckbox.setText(org.openide.util.NbBundle.getMessage(UIExporterLoCoGEXFPanel.class, "UIExporterGEXFPanel.colorsExportCheckbox.text")); // NOI18N

        attributesExportCheckbox.setText(org.openide.util.NbBundle.getMessage(UIExporterLoCoGEXFPanel.class, "UIExporterGEXFPanel.attributesExportCheckbox.text")); // NOI18N

        sizeExportCheckbox.setText(org.openide.util.NbBundle.getMessage(UIExporterLoCoGEXFPanel.class, "UIExporterGEXFPanel.sizeExportCheckbox.text")); // NOI18N

        labelNormalize.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        labelNormalize.setForeground(new java.awt.Color(102, 102, 102));
        labelNormalize.setText(org.openide.util.NbBundle.getMessage(UIExporterLoCoGEXFPanel.class, "UIExporterGEXFPanel.labelNormalize.text")); // NOI18N

        normalizeCheckbox.setText(org.openide.util.NbBundle.getMessage(UIExporterLoCoGEXFPanel.class, "UIExporterGEXFPanel.normalizeCheckbox.text")); // NOI18N

        dynamicExportCheckbox.setText(org.openide.util.NbBundle.getMessage(UIExporterLoCoGEXFPanel.class, "UIExporterGEXFPanel.dynamicExportCheckbox.text")); // NOI18N

        roleExportCheckbox.setText(org.openide.util.NbBundle.getMessage(UIExporterLoCoGEXFPanel.class, "UIExporterLoCoGEXFPanel.roleExportCheckbox.text")); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(roleExportCheckbox)))
                    .addGroup(layout.createSequentialGroup()
    ...
    private javax.swing.JCheckBox roleExportCheckbox;
